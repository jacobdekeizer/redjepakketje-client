...
trait FromArray
{
    ...
    protected function convertFromArrayData(string $key, mixed $value): mixed
    {
        return $value;
    }

    private static function convertToType(ReflectionParameter $reflectionParameter, mixed $value)
    {
